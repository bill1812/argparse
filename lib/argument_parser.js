...
ArgumentParser.prototype._parseKnownArgs = function (argStrings, namespace) {
  ...
  argStrings.forEach(function (argString, argStringIndex) {
    ...
    /* used for \test\fromfile.js
    for (var property in optionStringIndices) {
      if (optionStringIndices.hasOwnProperty(property)) {
        console.log(
          '    * argument_parser #356 optionStringIndices property: ',
          property,
          ',\n    value:\n    ',
          optionStringIndices[property]
        );
      }
    }
    console.log('-------------------------------------------------------------------- End of #356 ---');
    console.log('    * argument_parser #365 argStringPatternParts: "' +
      argStringPatternParts + '"' + ', counter: ' + counter
    );
    ++counter;
    console.log('-------------------------------------------------------------------- End of #365 ---');
    */
  });
  ...
  while (startIndex <= maxOptionStringIndex) {
    ...
    for (position in optionStringIndices) {
      ...
      if (optionStringIndices.hasOwnProperty(position)) {
        console.log(
          '    * startIndex <= maxOptionStringIndex #538 optionStringIndices property: ',
          position,
          ',\n    value:\n    ',
          optionStringIndices[position]
        );
      }
      console.log('-------------------------------------------------------------------- End of #538 ---'); */
    }
  ...
  if (chars.indexOf(optionString[0]) >= 0 && chars.indexOf(optionString[1]) >= 0) {
    ...
    for (actionOptionString in this._optionStringActions) {
      if (actionOptionString.substr(0, optionPrefix.length) === optionPrefix) {
        ...
        /* console.log('#814 action: ' + action + ', actionOptionString: ' +
          actionOptionString + ', argExplicit: ' + argExplicit
        );
        console.log('-------------------------------------------------------------------- End of #814 ---'); */
        result.push([action, actionOptionString, argExplicit]);
      } /*
      if (this._optionStringActions.hasOwnProperty(actionOptionString)) {
        console.log(
          '    * _getOptionTuples #821 this._optionStringActions property: ',
          actionOptionString,
          ',\n    value:\n    ',
          this._optionStringActions[actionOptionString]
        );
        console.log('-------------------------------------------------------------------- End of #821 ---');
      } */
    }
  ...
  // separate
    ...
    for (actionOptionString in this._optionStringActions) {
      ...
      if (actionOptionString === optionPrefixShort) {
        /* console.log('#845 action: ' + action + ', actionOptionString: ' +
          actionOptionString + ', argExplicitShort: ' + argExplicitShort
        );
        console.log('-------------------------------------------------------------------- End of #845 ---'); */
        result.push([action, actionOptionString, argExplicitShort]);
      } else if (actionOptionString.substr(0, optionPrefix.length) === optionPrefix) {
        /* console.log('#851 action: ' + action + ', actionOptionString: ' +
          actionOptionString + ', argExplicit: ' + argExplicit
        );
        console.log('-------------------------------------------------------------------- End of #851 ---'); */
        result.push([action, actionOptionString, argExplicit]);
      } /*
      if (this._optionStringActions.hasOwnProperty(actionOptionString)) {
        console.log(
          '    * _getOptionTuples #858 this._optionStringActions property: ',
          actionOptionString,
          ',\n    value:\n    ',
          this._optionStringActions[actionOptionString]
        );
        console.log('-------------------------------------------------------------------- End of #858 ---');
      } */
    }
...
ArgumentParser.prototype._getNargsPattern = function (action) {
  ...
  switch (action.nargs) {
    ...
    default:
      ...
      // console.log('#910 _getNargsPattern regexpNargs: ' + regexpNargs);
      // console.log('-------------------------------------------------------------------- End of #910 ---');
  }
